  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section>
        <div className="relative w-full h-96 bg-cover bg-center" style={{ backgroundImage: "url('/baniere1.png')" }}>
          <div className="absolute inset-0 flex items-center justify-left ">
            <h1 className="text-white text-5xl font-bold text-center animate-fade-in-left">Qui Sommes-Nous</h1>
          </div>
          <div className="absolute inset-0 flex items-center justify-end ">
            <img src="/MacBook Air (2022).png" alt="" className="w-2/4 h-auto animate-fade-in-right" />
          </div>
        </div>
        </section>
        <Section 
