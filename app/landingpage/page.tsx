          ...
          <div className="bg-white rounded-2xl p-4 shadow-md">
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-red-500 rounded-xl overflow-hidden">
                <Image src="/betterave.jpg" alt="Betterave" width={100} height={100} layout="responsive" />
              </div>
              <div className="bg-pink-900 rounded-xl overflow-hidden">
                <Image src="/haricots-verts.jpg" alt="Haricots Verts" width={100} height={100} layout="responsive" />
              </div>
              <div className="bg-pink-900 rounded-xl overflow-hidden">
                <Image src="/cavolo-nero-kale.jpg" alt="Cavolo Nero Kale" width={100} height={100} layout="responsive" />
              </div>
              <div className="bg-pink-900 rounded-xl overflow-hidden">
                <Image src="/radis.jpg" alt="Radis" width={100} height={100} layout="responsive" />
              </div>
            </div>
...
export default function LandingPage() {
  return (
      ...
      <div className="container mx-auto">
        ...
        <div className="w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="w-full h-56 relative p-3">
              <div className="w-full h-full absolute rounded-3xl border-4 border-green-500" />
              <div className="absolute left-8 bottom-8 text-green-800 text-xl sm:text-2xl md:text-3xl font-semibold font-['Montserrat'] leading-tight tracking-tight">Fruits et légumes</div>
              <img className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2" src="icons/healthy-food 1.png" alt="Fruits et légumes" />
            </div>
            
            <div className="w-full h-56 relative p-3">
              <div className="w-full h-full absolute rounded-3xl border-4 border-green-500" />
              <div className="absolute left-4 bottom-8 text-green-800 text-xl sm:text-2xl md:text-3xl font-semibold font-['Montserrat'] leading-tight tracking-tight">Viandes et Poissons</div>
              <img className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2" src="icons/fish 1.png" alt="Poisson" />
            </div>
            
            <div className="w-full h-56 relative p-3">
              <div className="w-full h-full absolute rounded-3xl border-4 border-green-500" />
              <div className="absolute left-8 bottom-8 text-green-800 text-xl sm:text-2xl md:text-3xl font-semibold font-['Montserrat'] leading-tight tracking-tight">Laitière et Œufs</div>
              <div className="absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2">
                <img className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2" src="icons/Group 57.png" alt="Lait et Œufs" />
              </div>
            </div>
            
            <div className="w-full h-56 relative p-3">
              <div className="w-full h-full absolute rounded-3xl border-4 border-green-500" />
              <div className="absolute left-1/3 bottom-8 text-green-800 text-xl sm:text-2xl md:text-3xl font-semibold font-['Montserrat'] leading-tight tracking-tight">Céréales</div>
              <img className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 absolute left-1/2 top-1/4 transform -translate-x-1/2 -translate-y-1/2" src="icons/wheat 1.png" alt="Blé" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="py-8 px-4 w-full min-h-[15vh] flex items-center">
      <div className="container mx-auto">
        <div className="text-green-800 text-4xl sm:text-5xl md:text-6xl font-semibold font-['Montserrat'] leading-tight tracking-widest mb-12 text-center">LES PLUS DEMANDÉS</div>
            <ProductListing/>
      </div>
    </section>
    ...
    <section className="py-8 px-4 w-full min-h-[15vh] flex items-center">
      <div className="container mx-auto">
        <div className="text-green-800 text-4xl sm:text-5xl md:text-6xl font-semibold font-['Montserrat'] leading-tight tracking-widest mb-12 text-center">NOS PRODUITS</div>
            <ProductListing/>
      </div>
    </section>
    </div>
